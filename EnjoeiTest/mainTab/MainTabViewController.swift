...
class MainTabViewController: UITabBarController {
    ...
    private func addTabs() {
        ...
        homeController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "ic_home"), selectedImage: UIImage(named: "ic_home_selected"))
        ...
        earchController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "ic_search"), selectedImage: UIImage(named: "ic_search_selected"))
        ...
        uploadController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "ic_upload"), selectedImage: UIImage(named: "ic_upload_selected"))
        ...
        inboxController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "ic_inbox"), selectedImage: UIImage(named: "ic_inbox_selected"))
        
        let profileController = UINavigationController(rootViewController: profileViewController)
        profileViewController.title = NSLocalizedString("profile", comment: "")
        profileController.tabBarItem = UITabBarItem(title: nil, image: UIImage(named: "ic_avatar")?.withRenderingMode(.alwaysOriginal), selectedImage: UIImage(named: "ic_avatar_selected")?.withRenderingMode(.alwaysOriginal))
